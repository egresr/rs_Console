...
namespace Schnee
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Niederschlag niederschlag1 = new Niederschlag(schneewolke1);
            Niederschlag niederschlag2 = new Niederschlag(schneewolke2);
            niederschlag1.Schneit();
            niederschlag2.Schneit();
